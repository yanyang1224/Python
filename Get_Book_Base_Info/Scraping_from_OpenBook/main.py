...
def getInfoFromOpenBook(pageIndex,pageSize=500):
    try:
        response = session.get('http://www.openbookdata.com.cn/Templates/BookListTemplate.tt?_ver=636063318682891054&_orderindex=0&_ordertype=0&__mode=1&_pageIndex='+str(pageIndex)+'&_pageSize='+str(pageSize)+'&ts=1564190831351&showtype=1&title=&author=&pubname=&plotname=&publishsdate=&publishedate=&selShip=-1&starttime=&endtime=&chkispub=0&chkisrecommend=0&selkind=&kinds=C-1%252CT-1%252CI-1%252CH-1%252CW-1%252CY-1%252CG-1%252CZ-1%252C&pd=&st=&rurl=http%253A%2F%2Fwww.openbookdata.com.cn%2FBookSearch%2FBookList.aspx%253Fpr1%253D%2526pr2%253D%2526pr3%253D%2526pr4%253D%2526pr5%253D%2526pr5e%253D%2526pr6%253D-1%2526pr7%253D%2526pr8%253D%2526pr9%253D0%2526pr10%253D0%2526pr11%253D%2526pr12%253DC-1%252CT-1%252CI-1%252CH-1%252CW-1%252CY-1%252CG-1%252CZ-1%252C%2526pr23%253D%2526pr24%253D&pmin=&pmax=',headers=headers)
...
def main():
    loginOpenBook()
    response = session.get('http://www.openbookdata.com.cn/Templates/BookListTemplate.tt?_ver=636063318682891054&_orderindex=0&_ordertype=0&__mode=1&_pageIndex=1&_pageSize=50&ts=1564190831351&showtype=1&title=&author=&pubname=&plotname=&publishsdate=&publishedate=&selShip=-1&starttime=&endtime=&chkispub=0&chkisrecommend=0&selkind=&kinds=C-1%252CT-1%252CI-1%252CH-1%252CW-1%252CY-1%252CG-1%252CZ-1%252C&pd=&st=&rurl=http%253A%2F%2Fwww.openbookdata.com.cn%2FBookSearch%2FBookList.aspx%253Fpr1%253D%2526pr2%253D%2526pr3%253D%2526pr4%253D%2526pr5%253D%2526pr5e%253D%2526pr6%253D-1%2526pr7%253D%2526pr8%253D%2526pr9%253D0%2526pr10%253D0%2526pr11%253D%2526pr12%253DC-1%252CT-1%252CI-1%252CH-1%252CW-1%252CY-1%252CG-1%252CZ-1%252C%2526pr23%253D%2526pr24%253D&pmin=&pmax=',headers=headers)
    resJson = json.loads(response.text)
    count = resJson.get('cnt')
    pageCount = math.ceil(count / 500) + 1
    print(pageCount)
    # getInfoFromOpenBook(1)
    for pageIndex in range(9066,pageCount):
