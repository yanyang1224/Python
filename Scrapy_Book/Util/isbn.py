...
class Isbn (object):
	...
	def __init__ (self, isbn_str):
		...
		"""
		# Main:
		clean_str = Util.ISBNHelper.clean_isbn (isbn_str)
	...
	def _set_isbn10 (self, isbn_str):
		isbn_str = Util.ISBNHelper.clean_isbn (isbn_str)
		assert (len (isbn_str) == 10)
		self._isbn10 = isbn_str
		self._isbn13 = Util.ISBNHelper.isbn10_to_isbn13 (isbn_str)
		self._sbn = Util.ISBNHelper.isbn10_to_sbn (isbn_str)
	...
	def _set_isbn13 (self, isbn_str):
		...
		self._isbn10 = Util.ISBNHelper.isbn13_to_isbn10 (isbn_str)
		if (self._isbn10):
			self._sbn = Util.ISBNHelper.isbn10_to_sbn (self._isbn10)
		else:
			self._sbn = None
	...
	def _set_sbn (self, sbn_str):
		sbn_str = Util.ISBNHelper.clean_isbn (sbn_str)
		assert (len (sbn_str) == 9)
		self._sbn = sbn_str
		self._isbn10 = Util.ISBNHelper.sbn_to_isbn10 (sbn_str)
		self._isbn13 = Util.ISBNHelper.isbn10_to_isbn13 (self._isbn10)
